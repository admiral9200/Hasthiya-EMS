...
export default {
    ...
    methods: {
        getPage(page) {
            this.page = page
            this.$router.push({ name: "userByDesignation",params: { id:this.$route.params.id }, query: { page: page } })
        },
        getAllUsersByDesignation() {
            this.$store.dispatch("getAllUsersByDesignation", { id: this.$route.params.id, page: this.$route.query.page });
        },
    },
    components: {
        PaginationComponent,
