...
export default {
    ...
    methods: {
        getPage(page) {
            this.page = page
            this.$router.push({ name: "userByTech",params: { id:this.$route.params.id }, query: { page: page } })
        },
        getAllUsersByTechnology() {
            this.$store.dispatch("getAllUsersByTechnology", { id: this.$route.params.id, page: this.$route.query.page });
        },
    },
    components: {
        PaginationComponent,
